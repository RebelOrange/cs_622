...
class EfficientNet(Model):
    ...
    def train(self, df, epochs=10, batch_size=32, save_interval=1, save_best=True, load_best=True):
        ...
        # lists for storing epoch losses and epoch accuracies
        epoch_losses = []
        epoch_accuracies = []
        ...
        for epoch in range(start_epoch, start_epoch + epochs):
            ...
            # store epoch loss and accuracy in corresponding list
        ...
        # return epoch loss and accuracy lists
...
if __name__ == "__main__":
    ...
    loss, accuracy = model.train(dm.TrainingData, epochs=20, batch_size=64, save_interval=2, save_best=True, load_best=True)
