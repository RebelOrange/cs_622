...
def PlotTrainingProgress(main_csv, additional_csvs, save_plot=False):
    ...
    for csv_file in additional_csvs:
        ...
        try:
            ...
            print("CSV file not found: {}".format(csv_file))
...
if __name__ == "__main__":
    ...
    additional_training_csvs = [f"ResNet_Training_{lr}_stats.csv" for lr in [0.0001, 0.001, 0.00001, 0.000001]]
    ...
    if TRAIN_MODEL:
        ...
        ResNetStatsFinal = {}
        learning_rates = [0.0001, 0.001, 0.00001, 0.000001]
        n_epochs = 40
